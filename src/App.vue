    ...
    <article class="age-calculator">
      <form id="form" class="form-container" @submit.prevent="validateForm()">
        <div class="input-wrapper">
          ...
          />
          <p v-if="errors.day" :class="{ error: errors.day }">
            {{ errors.day }}
          </p>
        </div>
        <div class="input-wrapper">
          ...
          />
          <p v-if="errors.month" :class="{ error: errors.month }">
            {{ errors.month }}
          </p>
        </div>
        <div class="input-wrapper">
          ...
          />
          <p v-if="errors.year" :class="{ error: errors.year }">
            {{ errors.year }}
          </p>
        </div>
      </form>
      <div class="icon-group">
        <button form="form" @click="validateForm()">
          <svg
...
.p-group span {
  ...
  font-style: italic;
  font-size: clamp(3.25rem, 0.376vw + 3.162rem, 3.5rem);
  line-height: 3.5rem;
}
